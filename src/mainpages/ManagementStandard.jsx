...
const slides = [
  {
    ...
    content: "We replace chaos with coordination. Our managed service model ensures that technical complexity is handled behind the scenes. Scroll or Swipe to explore our pillars.",
    image: null, 
  },
  {
    id: 1,
    ...
    category: 'Core Value',
    title: 'Total Synergy',
    content: "We don't work in silos. Your web developer talks to your SEO manager; your video editor aligns with your brand strategist. We create a unified vision.",
  ...
  },
  {
    ...
    content: "Every project follows a strict lifecycle—Planning, Execution, Quality Assurance, and Delivery. We minimize risk through rigorous structure.",
    image: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=1000&q=80", 
  },
  {
    id: 3,
    type: 'content',
    ...
    title: 'Scalability',
    content: "We build solutions that grow as you grow. Our systems are designed to handle your expansion without needing to be rebuilt from scratch.",
    image: "https://inc42.com/cdn-cgi/image/quality=75/https://asset.inc42.com/2023/10/Glossary-Series-Startups-f7.png", 
  },
  {
    id: 4,
    type: 'content',
    ...
    content: "Design is not just how it looks, but how it works. We align aesthetics with functionality to create seamless user experiences.",
...
const ManagementStandard = () => {
  ...
  const getCardStyle = () => {
    ...
    if (animState === 'exiting') {
       transform = `translateX(${direction * -100}px) rotateY(${direction === 1 ? -45 : 45}deg) scale(0.85)`;
       opacity = 0;
          ...
          >
            {!isIntro && (
              ...
              >
                  ...
                  style={{ borderColor: PALETTE.highlight, color: PALETTE.text, backgroundColor: `${PALETTE.highlight}20` }}
                  >
            ...
            <div className={`overflow-hidden ${isIntro ? 'max-w-2xl' : 'max-w-lg'}`}>
              <p 
            ...
            {isIntro && (
                ...
                >
                    <span className="text-[10px] md:text-xs uppercase tracking-[0.2em]">Scroll to Explore</span>
          ...
          {!isIntro && (
              ...
              >
                  ...
                  >
                      ...
                      />
                      <div className="absolute inset-0 mix-blend-overlay opacity-60" style={{ backgroundColor: PALETTE.highlight }} />
                      ...
                      <div className="flex justify-between items-end transform translate-y-0 opacity-100 md:translate-y-4 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500">
                          <div>
                              <p className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-60">{currentSlide.number}</p>
                              <p className="text-lg md:text-xl font-bold">{currentSlide.category}</p>
                          </div>
                          <div 
        ...
        <div className="absolute bottom-8 md:bottom-12 left-1/2 -translate-x-1/2 flex gap-4 z-30">
          {slides.map((_, idx) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 cursor-pointer ${idx === activeIdx ? 'w-10 md:w-12' : 'w-2 opacity-30 hover:opacity-60'}`}
              style={{ backgroundColor: idx === activeIdx ? PALETTE.highlight : PALETTE.text }}
